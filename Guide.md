...
|  ----  | ----  |
|`{`||
|`"configVersion": 0.3,`<br>//配置文件版本标记，请不要随意改动| |
|`"Servers": [{...},{...}],`<br>//[{服务器1},{服务器2},······]无上限  | [WS服务器配置](#WS服务器配置)|
|`"CheckConnectionTime": 60,`<br>//检查连接时长，如果服务器掉线了会在检查后自动重连，单位:秒||
|`"Groups": [{...},{...}],`<br>//[{群聊1},{群聊2},······]无上限(每个群聊单独配置)| [群聊配置](#群聊配置)|
|`"Timers": [{...},{...}],`|[计时器](#计时器)|
|`"Tasks": [{...},{...}]`|[定时任务](#定时任务)|
|`}`||
---
